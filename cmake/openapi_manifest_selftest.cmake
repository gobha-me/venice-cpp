...
string(JSON _bad REMOVE "${_manifest}" operations 0 tracking_issue)
expect_invalid("planned operation without issue" "${_bad}" "tracking_issue is required")

string(JSON _bad SET "${_manifest}" operations 0 tracking_issue 26)
expect_invalid("planned operation linked only to a child ticket" "${_bad}" "not a family issue under #36")

string(JSON _bad SET "${_manifest}" operations 0 state "\"implemented\"")
...
validate_openapi_coverage_text("OpenAPI coverage: 12/49 operations implemented." "OpenAPI coverage: 16/49 operations implemented." _coverage_ok)
if(_coverage_ok)
...
if(NOT _ok OR NOT _total EQUAL 49 OR NOT _implemented EQUAL 16)
