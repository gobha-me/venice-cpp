...
# Row 4 remains planned (the Web3 token operation); row 0 is now implemented.
...
string(JSON _bad REMOVE "${_manifest}" operations 4 tracking_issue)
expect_invalid("planned operation without issue" "${_bad}" "tracking_issue is required")

string(JSON _bad SET "${_manifest}" operations 4 tracking_issue 26)
...
validate_openapi_coverage_text("OpenAPI coverage: 19/49 operations implemented." "OpenAPI coverage: 25/49 operations implemented." _coverage_ok)
if(_coverage_ok)
...
if(NOT _ok OR NOT _total EQUAL 49 OR NOT _implemented EQUAL 25)
