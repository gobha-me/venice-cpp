...
# Row 27 remains planned (the first Crypto RPC operation); row 0 is implemented.
...
string(JSON _bad REMOVE "${_manifest}" operations 27 tracking_issue)
expect_invalid("planned operation without issue" "${_bad}" "tracking_issue is required")

string(JSON _bad SET "${_manifest}" operations 27 tracking_issue 26)
...
validate_openapi_coverage_text("OpenAPI coverage: 27/49 operations implemented." "OpenAPI coverage: 42/49 operations implemented." _coverage_ok)
if(_coverage_ok)
...
if(NOT _ok OR NOT _total EQUAL 49 OR NOT _implemented EQUAL 42)
