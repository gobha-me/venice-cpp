...
//
// Link: venice-cpp is header-only (INTERFACE). Consumers need c-ares,
// cpp-httplib, nlohmann/json, and OpenSSL — provided transitively when linking
// the `venice-cpp::lib` CMake target.
